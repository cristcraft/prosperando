...
<head>
    ...
    <meta charset="utf-8">
    <title>NoSQLAuthorizationError - Oracle NoSQL Database Node.js SDK</title>
...
<header>
        ...
        NoSQLAuthorizationError
            ...
            <div class="class-description usertext">This class covers all errors that occur while acquiring authorization to
...
error codes:
<ul>
<li><a href="ErrorCode.html#.BAD_PROTOCOL_MESSAGE">ErrorCode.BAD_PROTOCOL_MESSAGE</a> indicates problem in
authorization protocol.</li>
<li><a href="ErrorCode.html#.ILLEGAL_STATE">ErrorCode.ILLEGAL_STATE</a> indicates that authorization operation
...
<li><a href="ErrorCode.html#.ILLEGAL_ARGUMENT">ErrorCode.ILLEGAL_ARGUMENT</a> indicates problem with
authorization configuration provided as <a href="global.html#AuthConfig">AuthConfig</a> when
<a href="NoSQLClient.html">NoSQLClient</a> instance is created.</li>
<li><a href="ErrorCode.html#.REQUEST_TIMEOUT">ErrorCode.REQUEST_TIMEOUT</a> indicates that timeout was exceeded
trying to obtain authorization information.</li>
<li><a href="ErrorCode.html#.SERVICE_ERROR">ErrorCode.SERVICE_ERROR</a> indicates unsuccessful response
...
more information</li>
<li><a href="ErrorCode.html#.UNAUTHORIZED">ErrorCode.UNAUTHORIZED</a> may indicate insufficient permissions
while trying to obtain authorization information.
<li><a href="ErrorCode.html#.CREDENTIALS_ERROR">ErrorCode.CREDENTIALS_ERROR</a> indicates error accessing user or
application credentials.  The reason for this error depends on what
credential provider is used for the authorization.</li>
<li><a href="ErrorCode.html#.NETWORK_ERROR">ErrorCode.NETWORK_ERROR</a> indicates error communicating with the
...
<a href="NoSQLError.html#cause">NoSQLError#cause</a>.  The message should contain HTTP status code and
...
authorization string.  In the latter case, <a href="NoSQLError.html">NoSQLError</a> is returned
with error code <a href="ErrorCode.html#.INVALID_AUTHORIZATION">ErrorCode.INVALID_AUTHORIZATION</a>.</div>
...
<article>
    ...
    <ul>
        <li><a href="NoSQLError.html">NoSQLError</a></li>
    </ul>
...
<h4 class="name" id="cause"><span class="type-signature">(readonly) </span>cause<span class="type-signature"> :Error|undefined</span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="error.js.html">error.js</a>, <a href="error.js.html#line87">line 87</a>
    </li></ul></dd>
    ...
    <dd class="tag-overrides"><ul class="dummy"><li>
        <a href="NoSQLError.html#cause">NoSQLError#cause</a>
    </li></ul></dd>
...
<a href="NoSQLError.html">NoSQLError</a> and may itself have a cause.  You could iterate
...
<h4 class="name" id="errorCode"><span class="type-signature">(readonly) </span>errorCode<span class="type-signature"> :<a href="ErrorCode.html">ErrorCode</a></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="error.js.html">error.js</a>, <a href="error.js.html#line71">line 71</a>
    </li></ul></dd>
    ...
    <dt class="tag-overrides">Overrides:</dt>
    <dd class="tag-overrides"><ul class="dummy"><li>
        <a href="NoSQLError.html#errorCode">NoSQLError#errorCode</a>
    </li></ul></dd>
...
<div class="description usertext">
    <a href="ErrorCode.html">ErrorCode</a> of this error.
</div>
...
<span class="param-type"><a href="ErrorCode.html">ErrorCode</a></span>
...
<h4 class="name" id="operation"><span class="type-signature">(readonly) </span>operation<span class="type-signature"> :<a href="global.html#Operation">Operation</a>|<a href="global.html#Config">Config</a>|undefined</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-overrides">Overrides:</dt>
    <dd class="tag-overrides"><ul class="dummy"><li>
        <a href="NoSQLError.html#operation">NoSQLError#operation</a>
    </li></ul></dd>
    ...
    <dd class="tag-see">
        <ul>
            <li><a href="global.html#Operation">Operation</a></li>
...
<a href="global.html#Operation">Operation</a> object contains the API and its arguments including
the options used.  Operation object may not always be available, in
which case the value of this property is <em>undefined</em>.
<p>
If this error happened during creation of new <a href="NoSQLClient.html">NoSQLClient</a> then
instead of <a href="global.html#Operation">Operation</a> this property contains <a href="global.html#Config">Config</a>
used to create <a href="NoSQLClient.html">NoSQLClient</a> instance.
</div>
...
<span class="param-type"><a href="global.html#Operation">Operation</a></span>
|
...
<h4 class="name" id="retryable"><span class="type-signature">(readonly) </span>retryable<span class="type-signature"> :boolean</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="error.js.html">error.js</a>, <a href="error.js.html#line106">line 106</a>
    </li></ul></dd>
    ...
    <dt class="tag-overrides">Overrides:</dt>
    <dd class="tag-overrides"><ul class="dummy"><li>
        <a href="NoSQLError.html#retryable">NoSQLError#retryable</a>
    </li></ul></dd>
    ...
    <dd class="tag-see">
        <ul>
            <li><a href="global.html#RetryConfig">RetryConfig</a></li>
        </ul>
    </dd>
...
driver's default <a href="global.html#RetryHandler">RetryHandler</a>.  Default retry handler can be
customized by properties in <a href="global.html#RetryConfig">RetryConfig</a>.  Alternatively, a
custom <a href="global.html#RetryHandler">RetryHandler</a> can be set as
<a href="global.html#RetryConfig">RetryConfig</a>#handler.
<p>
