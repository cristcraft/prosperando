...
<body id="body">
    <nav class="navbar navbar-expand-lg navbar-light bg-light" id="navbar">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Resolucion</a>
        ...
        <div class="tabla">
            <table id="equipos" class="table text-center mt-4">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <a onclick="editResolucion_tablets(<?php echo $row['id']?>, '<?php echo $row['resolucion'] ?>')"  class="btn btn-outline-info"><i class="fas fa-edit"></i></a>
