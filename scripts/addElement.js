...
function addSucursal(){
    ...
    if(sucursal !== null){
        window.location.href = `../addElements/addElements.php?table=sucursal&accion=add&sucursal=${sucursal}`
    }
}
...
function editSucursal(id, old){
    ...
    if(sucursal !== null){
        window.location.href = `../addElements/addElements.php?table=sucursal&accion=edit&sucursal=${sucursal}&id=${id}&old=${old}`
    }
}
...
function deleteSucursal(id, name){
    ...
    if(confirm1){
        window.location.href = `../addElements/addElements.php?table=sucursal&accion=delete&id=${id}`
    }
}
//===============================================================================
...
function addArea(){
    ...
    if(area){
        window.location.href = `../addElements/addElements.php?table=area&accion=add&area=${area}`
    }
}
...
function editAreas(id,old){
    ...
    if(area !== null){
        window.location.href = `../addElements/addElements.php?table=area&accion=edit&area=${area}&id=${id}&old=${old}`
    }
}
...
function deleteAreas(id, name){
    let confirm1 = confirm(`¿Seguro quieres eliminar ${name}?`)
    if(confirm1){
        window.location.href = `../addElements/addElements.php?table=area&accion=delete&id=${id}`
    }
}
...
function addMarcas(){
    ...
    if(marca){
        window.location.href = `../addElements/addElements.php?table=marca&accion=add&marca=${marca}`
    }
}
...
function editMarcas(id, old){
    ...
    if(marca !== null){
        window.location.href = `../addElements/addElements.php?table=marca&accion=edit&marca=${marca}&id=${id}&old=${old}`
    }
}
...
function deleteMarcas(id, name){
    let confirm1 = confirm(`¿Seguro quieres eliminar ${name}?`)
    if(confirm1){
        window.location.href = `../addElements/addElements.php?table=marca&accion=delete&id=${id}`
    }
}
...
function addProcesadores(){
    ...
    if(procesador){
        window.location.href = `../addElements/addElements.php?table=procesador&accion=add&procesador=${procesador}`
    }
}
...
function editProcesadores(id,old){
    ...
    if(procesador !== null){
        window.location.href = `../addElements/addElements.php?table=procesador&accion=edit&procesador=${procesador}&id=${id}&old=${old}`
    }
}
...
function deleteProcesadores(id, name){
    let confirm1 = confirm(`¿Seguro quieres eliminar ${name}?`)
    if(confirm1){
        window.location.href = `../addElements/addElements.php?table=procesador&accion=delete&id=${id}`
    }
}
...
function addTipo_memorias(){
    ...
    if(tipo_memoria){
        window.location.href = `../addElements/addElements.php?table=tipo_memoria&accion=add&tipo_memoria=${tipo_memoria}`
    }
}
...
function editTipo_memorias(id,old){
    ...
    if(tipo_memoria !== null){
        window.location.href = `../addElements/addElements.php?table=tipo_memoria&accion=edit&tipo_memoria=${tipo_memoria}&id=${id}&old=${old}`
    }
}
...
function deleteTipo_memorias(id, name){
    let confirm1 = confirm(`¿Seguro quieres eliminar ${name}?`)
    if(confirm1){
        window.location.href = `../addElements/addElements.php?table=tipo_memoria&accion=delete&id=${id}`
    }
}
...
function addMarca_disco_duro(){
    ...
    if(marca_disco_duro){
        window.location.href = `../addElements/addElements.php?table=marca_disco_duro&accion=add&marca_disco_duro=${marca_disco_duro}`
    }
}
...
function editMarca_disco_duro(id,old){
    ...
    if(marca_disco_duro !== null){
        window.location.href = `../addElements/addElements.php?table=marca_disco_duro&accion=edit&marca_disco_duro=${marca_disco_duro}&id=${id}&old=${old}`
    }
}
...
function deleteMarca_disco_duro(id, name){
    ...
    if(confirm1){
        window.location.href = `../addElements/addElements.php?table=marca_disco_duro&accion=delete&id=${id}`
    }
}
//===============================================================================
...
function addTipos_disco(){
    ...
    if(tipos_disco){
        window.location.href = `../addElements/addElements.php?table=tipo_disco&accion=add&tipo_disco=${tipos_disco}`
    }
}
...
function editTipos_disco(id,old){
    ...
    if(tipos_disco !== null){
        window.location.href = `../addElements/addElements.php?table=tipo_disco&accion=edit&tipo_disco=${tipos_disco}&id=${id}&old=${old}`
    }
}
...
function deleteTipos_disco(id, name){
    let confirm1 = confirm(`¿Seguro quieres eliminar la marca ${name}?`)
    if(confirm1){
        window.location.href = `../addElements/addElements.php?table=tipo_disco&accion=delete&id=${id}`
    }
}
//===============================================================================
