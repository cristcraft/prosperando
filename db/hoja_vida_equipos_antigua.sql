...
('115', 'Administración', 'sistemas', 'Jessica Moreno', 'DA-CS-PT-07', 'Oficina', '', 'Portatil', 'Lenovo', 'Lenovo ThinkBook 14-IIL', 'pendiente', '2021-11-17', 'QuadCore Intel Core i5', '1035G1', 4, 3300, 8, 'DDR4', 'Realtek ALC257 @ Intel Ice Point-LP PCH - cAVS (Audio, Voice, Speech)', '	Intel(R) UHD Graphics (1 GB)', 'SEAGATE', '1TB', 'SSD', 'Realtek PCIe GbE Family Controller', 'N.A', 'C0-18-50-26-28-D0', 'Intel(R) Wi-Fi 6 AX201 160MHz', '70-CF-49-D1-A8-1C', 'CMN N140HGA-EA1', 'LCD', 'pendiente', 'CMN', '14,0', 0, 0, 2, '45000 ', 'L19L3PF8', 'LENOVO', '12.536V', 'tipo C', 'Microsoft Windows 10 Pro', 64, 'pendiente'),
('50', 'Administración', 'sistemas', 'Juan Manuel Medina Ocampo', 'DA-CS-PT-08', 'Oficina', '', 'Portatil', 'Lenovo', 'Lenovo ThinkBook 14-IIL', 'pendiente', '2021-11-17', 'QuadCore Intel Core i5', '1035G1', 4, 3300, 8, 'DDR4', 'Realtek ALC257 @ Intel Ice Point-LP PCH - cAVS (Audio, Voice, Speech)', '	Intel(R) UHD Graphics (1 GB)', 'SEAGATE', '1TB', 'SSD', '	Realtek PCIe GbE Family Controller', 'N.A', 'C0-18-50-26-28-51', 'Intel(R) Wi-Fi 6 AX201 160MHz', '70-CF-49-CE-79-F3', 'CMN N140HGA-EA1', 'LCD', 'CMN14E5', 'CMN', '13.9', 0, 0, 2, 'L19C3PF9', '46840 ', 'lenovo', '12.515 ', 'tipo C', 'Microsoft Windows 10 Pro', 64, 'pendiente'),
('PC001', 'Administración', 'Talento humano', 'Camilo Andres Perez', 'DA-GD-PC-01', 'Oficina', 'HP Compaq 6200 Pro SFF', 'Desktop', 'HP', 'HP', 'MXL21405X1', '0000-00-00', 'DualCore Intel Core i3', '2120-', 2, 3300, 8, 'DDR3', 'Intel Cougar Point HDMI @ Intel Cougar Point PCH - High Definition Audio Controller [B-2]', 'Intel(R) HD Graphics 2000 (2108 MB)', 'TOSHIBA', '1TB', 'SATA III', 'Intel(R) 82579LM Gigabit Network Connection', '', 'E8-39-35-4E-8B-36', 'NO', 'NO', 'HP', 'LCD', 'CNC212RJLW', 'HP LV2011', '20,0', 2, 1, 1, 'NO APLICA', 'NO APLICA', 'NO APLICA', 'NO APLICA', 'NO APLICA', 'Microsoft Windows 10 Pro', 64, 'BBBBB-BBBBB-BBBBB-BBBBB-BBBBB'),
