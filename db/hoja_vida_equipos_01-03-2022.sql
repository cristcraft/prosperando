...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-03-2022 a las 14:47:05
...
--
-- Estructura de tabla para la tabla `activos_inferiores`
--

CREATE TABLE `activos_inferiores` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `activos_inferiores`
--

INSERT INTO `activos_inferiores` (`id`, `fecha_compra`, `usuario_asignado`, `cedula`, `tipo_activo`, `sucursal`, `precio`) VALUES
(1, '2022-02-18', 'Cristian Peña', 1005755571, 'teclado', 'Bogotá', 15000),
(2, '2022-02-08', 'Cristian M.', 1005755571, 'mouse', 'Administración', 30000),
(3, '2022-02-11', 'Cristian ', 1005755571, 'diadema', 'Administración', 50000),
(6, '2022-02-27', 'Daniel ', 100575567, 'Monitor', 'S.S. de Mariquita', 500000),
(7, '2022-02-07', 'Daniel P.', 1005784844, 'mouse', 'Cartagena', 5000000),
(8, '2022-02-25', 'Andres', 1234657890, 'diadema', 'Girardot', 1234567);
...
(2, 'Administración', 'Asistentes', 'Escaner', 'KYOCERA', 'qqqq', 'sadf', 'asdf', 'asdf', 'asdf', 'asdf', 'Papel Normal, Papel Bond, Papel Reciclado, Sobre, Cartulina, Transparencies, Etiquetas');
...
--
-- Estructura de tabla para la tabla `marca_disco_duro`
--

CREATE TABLE `marca_disco_duro` (
  `id` int(11) NOT NULL,
  `nombre` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `marca_disco_duro`
--

INSERT INTO `marca_disco_duro` (`id`, `nombre`) VALUES
(1, 'HITACHI'),
(2, 'KINGSTON'),
(3, 'LEXAR'),
(4, 'SAMSUNG'),
...
INSERT INTO `sucursal` (`id`, `nombre`, `estado`) VALUES
...
(1, 'Cartagena', 'Asesora externa', 'dfasdf', 'asdf', 'Samsung', 'HP-V1910-48G aaa', 'QUALCOMM SNAPDRAGON 410', 0, 0, '1280*800', 'CN19BXS0Z1', 0, 0, 0, 0, 0, 'Androd 7.1.1');
...
--
-- Volcado de datos para la tabla `tipo_memoria`
--

INSERT INTO `tipo_memoria` (`id`, `nombre`) VALUES
(1, 'DDR2'),
(2, 'DDR3'),
(3, 'DDR4');
...
--
-- Indices de la tabla `activos_inferiores`
--
ALTER TABLE `activos_inferiores`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `marca_disco_duro`
--
ALTER TABLE `marca_disco_duro`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `activos_inferiores`
--
ALTER TABLE `activos_inferiores`
...
--
-- AUTO_INCREMENT de la tabla `marca_disco_duro`
--
ALTER TABLE `marca_disco_duro`
