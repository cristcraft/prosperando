        ...
        <form action="../../../components/equipos/edidForm.php" method="POST" id="form_edit_equipos" class="form" >
            <?php while($row = $result -> fetch_assoc()){ ?>
                ...
                <div class="mb-3">
                    ...
                    <input required type="text" name="nombre_equipo" id="nombre_equipo" placeholder="nombre del quipo" class="form-control" value="<?php echo $row['nombre_equipo'] ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    ?>
                        <option value="<?php echo $row2['lugar_de_trabajo'] ?>" <?php echo $select ?>><?php echo $row2['lugar_de_trabajo'] ?></option>
                    <?php
                        }
                    ?>
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <select name="tipo_equipo" id="tipo_equipo" class="form-control">
                        ...
                        ?>
                            <option value="<?php echo $row2['tipo'] ?>" <?php echo $select ?>><?php echo $row2['tipo'] ?></option>
                        <?php
                            }
                        ?>
                        </select>
                ...
                <div class="mb-3">
                    ...
                    <input required type="text" name="generacion_procesador" id="generacion_procesador" placeholder="generacion del procesador" class="form-control" value="<?php echo $row['generacion_procesador'] ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input required type="number" name="velocidad_mz" id="velocidad_mz" placeholder="velocidad en mz" class="form-control" value="<?php echo $row['velocidad_mz'] ?>">
                </div>

                <div class="mb-3">
                    <label for="ram_gb" class="form-label">RAM en GB</label>
                    <input required type="number" name="ram_gb" id="ram_gb" placeholder="ram en gb" class="form-control" value="<?php echo $row['ram_gb'] ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input required type="text" name="adaptador_multimedia" id="adaptador_multimedia" placeholder="adaptador multimedia" class="form-control" value="<?php echo $row['adaptador_multimedia'] ?>">
                </div>

                <div class="mb-3">
                    <label for="adaptador_video" class="form-label">Adaptador video</label>
                    <input required type="text" name="adaptador_video" id="adaptador_video" placeholder="adaptador video" class="form-control" value="<?php echo $row['adaptador_video'] ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input required type="text" name="capacidad_disco" id="capacidad_disco" placeholder="capacidad del disco" class="form-control" value="<?php echo $row['capacidad_disco'] ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input required type="text" name="red_ethernet" id="red_ethernet" placeholder="red ethernet" class="form-control" value="<?php echo $row['red_ethernet'] ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input required type="text" name="mac_ethernet" id="mac_ethernet" placeholder="mac_ethernet" class="form-control" value="<?php echo $row['mac_ethernet'] ?>">
                </div>

                <div class="mb-3">
                    <label for="red_wifi" class="form-label">Red wifi</label>
                    <input required type="text" name="red_wifi" id="red_wifi" placeholder="red wifi" class="form-control" value="<?php echo $row['red_wifi'] ?>">
                </div>

                <div class="mb-3">
                    <label for="mac" class="form-label">MAC</label>
                    <input required type="text" name="mac" id="mac" placeholder="mac" class="form-control" value="<?php echo $row['mac'] ?>">
                </div>

                <div class="mb-3">
                    <label for="marca_monitor" class="form-label">Marca del monitor</label>
                    <input required type="text" name="marca_monitor" id="marca_monitor" placeholder="Marca del monitor" class="form-control" value="<?php echo $row['marca_monitor'] ?>">
                </div>

                <div class="mb-3">
                    <label for="tipo_monitor" class="form-label">Tipo monitor</label>
                    <input required type="text" name="tipo_monitor" id="tipo_monitor" placeholder="Tipo monitor" class="form-control" value="<?php echo $row['tipo_monitor'] ?>">
                </div>

                <div class="mb-3">
                    <label for="serial_monitor" class="form-label">Serial monitor</label>
                    <input required type="text" name="serial_monitor" id="serial_monitor" placeholder="Serial monitor" class="form-control" value="<?php echo $row['serial_monitor'] ?>">
                </div>
                
                <div class="mb-3">
                    <label for="modelo_monitor" class="form-label">Modelo monitor</label>
                    <input required type="text" name="modelo_monitor" id="modelo_monitor" placeholder="Modelo monitor" class="form-control" value="<?php echo $row['modelo_monitor'] ?>">
                </div>

                <div class="mb-3">
                    <label for="pulgadas" class="form-label">Pulgadas monitor</label>
                    <input required type="text" name="pulgadas" id="pulgadas" placeholder="Pulgadas monitor" class="form-control" value="<?php echo $row['pulgadas'] ?>">
                </div>

                <div class="mb-3">
                    <label for="cables_poder" class="form-label">Cables de poder</label>
                    <input required type="number" name="cables_poder" id="cables_poder" placeholder="Cables de poder" class="form-control" value="<?php echo $row['cables_poder'] ?>">
                </div>

                <div class="mb-3">
                    <label for="vga" class="form-label">vga</label>
                    <input required type="number" name="vga" id="vga" placeholder="vga" class="form-control" value="<?php echo $row['vga'] ?>">
                </div>

                <div class="mb-3">
                    <label for="pass_core" class="form-label">Pass core</label>
                    <input required type="number" name="pass_core" id="pass_core" placeholder="Pass core" class="form-control" value="<?php echo $row['pass_core'] ?>">
                </div>

                <div class="mb-3">
                    <label for="bateria" class="form-label">Bateria</label>
                    <input required type="text" name="bateria" id="bateria" placeholder="Bateria" class="form-control" value="<?php echo $row['bateria'] ?>">
                </div>

                <div class="mb-3">
                    <label for="carga_electrica" class="form-label">Carga electrica</label>
                    <input required type="text" name="carga_electrica" id="carga_electrica" placeholder="Carga electrica" class="form-control" value="<?php echo $row['carga_electrica'] ?>">
                </div>

                <div class="mb-3">
                    <label for="cargador" class="form-label">Cargador</label>
                    <input required type="text" name="cargador" id="cargador" placeholder="Cargador" class="form-control" value="<?php echo $row['cargador'] ?>">
                </div>

                <div class="mb-3">
                    <label for="voltaje" class="form-label">Voltaje</label>
                    <input required type="text" name="voltaje" id="voltaje" placeholder="Voltaje" class="form-control" value="<?php echo $row['voltaje'] ?>">
                </div>

                <div class="mb-3">
                    <label for="salida_plug" class="form-label">Salida plug</label>
                    <input required type="text" name="salida_plug" id="salida_plug" placeholder="Salida plug" class="form-control" value="<?php echo $row['salida_plug'] ?>">
                </div>

                <div class="mb-3">
                    <label for="os" class="form-label">Sistema operativo</label>
                    <input required type="text" name="os" id="os" placeholder="Sistema operativo" class="form-control" value="<?php echo $row['os'] ?>">
                </div>
                

                <div class="mb-3">
                    <label for="bit" class="form-label">Bit</label>
                    <input required type="text" name="bit" id="bit" placeholder="Bit" class="form-control" value="<?php echo $row['bit'] ?>">
                </div>

                <div class="mb-3">
                    <label for="licencia" class="form-label">Licencia</label>
                    <input required type="text" name="licencia" id="licencia" placeholder="Licencia" class="form-control" value="<?php echo $row['licencia'] ?>">
                </div>
