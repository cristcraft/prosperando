    ...
    <div class="container-fluid d-flex justify-content-center align-items-center" id="form-content ">
        <form action="../../components/equipos/editForm.php" method="POST" id="form_create_equipos" class="form">
            ...
            <?php 
                while($rowEstructuraTabla = mysqli_fetch_array($resultEstructuraTabla)) {
                    if($rowEstructuraTabla['Null'] === 'NO'){
                        $sql = "SELECT ".$rowEstructuraTabla['Field']." FROM equipos WHERE id='$id'";
                            $resultData = $connection->query($sql);
                            while($rowData = $resultData -> fetch_assoc()){
                            echo '
                                    <input  type="number" name="'.$rowEstructuraTabla['Field'].'" id="'.$rowEstructuraTabla['Field'].'"
                                        placeholder="Number" class="form-control" hidden value="'.$rowData[$rowEstructuraTabla['Field']].'">
                            ';
                        }
                            ...
                            while($rowData = $resultData -> fetch_assoc()){
                                echo '
                                    <div class="mb-3">
                                        ...
                                        <input  type="number" name="'.$rowEstructuraTabla['Field'].'" id="'.$rowEstructuraTabla['Field'].'" 
                                        value="'.$rowData[$rowEstructuraTabla['Field']].'"    placeholder="Number" class="form-control">
                                    </div>
                                ';
                            }
                        ...
                        $sqldatoElegido = "SELECT ".$nombreTabla." FROM equipos where id=".$id."";
                        ...
                        while($rowData = $resultData -> fetch_assoc()){
                            ...
                            <div class="mb-3">
                                ...
                                <input  type="text" id="'.$rowEstructuraTabla['Field'].'" name="'.$rowEstructuraTabla['Field'].'" class="form-control"
                                    value="'.$rowData[$rowEstructuraTabla['Field']].'" require>
                            </div>
                        '; 
                        }
                        ...
                        while($rowData = $resultData -> fetch_assoc()){
                            echo '
                                <div class="mb-3">
                                    ...
                                    value="'.$rowData[$rowEstructuraTabla['Field']].'"    class="form-control">
                                </div>
                            ';
                        }
                    }
            ...
            <div class="mb-3 d-flex justify-content-around align-items-center">
                ...
                <a href="../../pages/equipos/equipos.php" class="btn btn-secondary" onclick="change('error')">Cancelar</a>
            </div>
