            ...
            <table id="equipos" class="table  text-center mt-4">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="#?<?php echo $rowEstructuraTabla['Field']; ?>"
                                onclick="editar('<?php echo $rowEstructuraTabla['Field']; ?>')"><i
                                    class="fas fa-edit"></i></a></td>
                        <td><a href="#?<?php echo $rowEstructuraTabla['Field']; ?>"
                                onclick="eliminar('<?php echo $rowEstructuraTabla['Field']; ?>')"><i
                                    class="fas fa-trash"></i></a></td>
                        <td><a href="#" onclick="agregar()"><i class="fas fa-plus-circle"></i></a></td>
                    </tr>
                    <?php
                                }
                            ?>
...
<script src="../../scripts/addColumns.js"></script>
