        ...
        <div class="form-buttons">
            <form action="../../../components/mantenimientos/equipos/saveForm.php" method="post" id="form-mante" class="form"> 
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="descripcion_mantenimiento" id="descripcion_mantenimiento"
                        class="form-control">
                </div>

                <div class="input-group mb-3">
                    <span class="input-group-text">Nombre del Técnico</span>
                    <input type="text" class="form-control" id="nombre_tecnico" class="form-control" name="nombre_tecnico">
                </div>
