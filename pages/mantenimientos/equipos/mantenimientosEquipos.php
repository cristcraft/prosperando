...
<body id="body">
    ...
    <div class="content-fluid contenido text-center m-3">
        <div class="form-buttons">
            <form action="../../../components/mantenimientos/equipos/saveForm.php" method="post" id="form-mante"
                class="form">
                <div>
                ...
                <div class="mb-3">
                    ...
                    <input required type="text" name="codigo_administrativo" id="codigo_administrativo" class="form-control"
                        placeholder="Codigo administrativo">
                </div>

                <div class="mb-3">
                    <label for="nombre_equipo" class="form-label">Nombre del equipo</label>
                    <input required type="text" name="nombre_equipo" id="nombre_equipo" class="form-control"
                ...
                <div class="mb-3">
                    ...
                    <input required type="text" class="form-control" id="nombre_tecnico" class="form-control"
                ...
                <div class="mb-3">
                    ...
                    <input required type="text" class="form-control" id="nombre_encargado" class="nombre_encargado"
                        name="nombre_encargado" placeholder="Nombre del encargado">
                </div>
            ...
            <div class="buttons m-2 d-flex">
                <div class="flex-direction-column">
                    ...
                    href="./mantenimientos_equipos.php">Descargar</a>
                </div>
        ...
        <div class="mantenimientos">
            <div class="mantenimientoAmbos d-flex flex-wrap justify-content-center d-none" id="mantenimientoAmbos">
                ...
                <form action="../../../components/mantenimientos/equipos/edidForm.php" method="post"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="text" class="form-control" name="descripcion_mantenimiento"
                            ...
                            class="form-control"><?php echo $row['descripcion_mantenimiento'] ?></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nombre_encargado" name="nombre_encargado"
                            class="nombre_encargado" value="<?php echo $row['nombre_encargado'] ?>">
                    </div>

                    <div class="mb-3">
                        <button class="btn btn-outline-dark mantenimiento" type="submit">Guardar cambios</button>
                        <a onclick="confirmar('<?php echo $row['id']?>', 'mantenimientosEquipos')"
            ...
            <div class="mantenimientoCorrectivo d-flex flex-wrap justify-content-center d-none"
                ...
                <form action="../../../components/mantenimientos/equipos/edidForm.php" method="post"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="text" class="form-control" name="descripcion_mantenimiento"
                            id="descripcion_mantenimiento" class="form-control"
                            value=""><?php echo $row['descripcion_mantenimiento'] ?></textarea>
                    </div>
