                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  active" aria-current="page"
                            href="../../components/router.php?page=switches">Switches</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid d-flex justify-content-center align-items-center" id="form-content ">
        <form action="../../components/switches/edidForm.php" method="POST" id="form_edit_switches" class="form">
            ...
            <div class="mb-3">
                ...
                <input required type="text" name="marca" id="marca" placeholder="funcionario responsable"
                    class="form-control" value="<?php echo $row['marca'] ?>">
            </div>
            ...
            <div class="mb-3 d-flex justify-content-around align-items-center">
                ...
                <a href="../../pages/switches/switches.php" class="btn btn-secondary" onclick="change('error')">Cancelar</a>
            </div>
        </form>
    </div>
