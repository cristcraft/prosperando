        ...
        <form action="../../../components/switches/edidForm.php" method="POST" id="form_edit_switches" class="form" >
            <?php while($row = $result -> fetch_assoc()){ ?>
                ...
                <div class="mb-3">
                    ...
                    <input required type="text" name="marca" id="marca" placeholder="funcionario responsable" class="form-control" value="<?php echo $row['marca'] ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input required type="text" name="manual" id="manual" placeholder="manual" class="form-control" value="<?php echo $row['manual'] ?>">
                </div>
            ...
            <div class="mb-3 d-flex justify-content-around align-items-center">
                ...
                <a href="../../../pages/switches/switches.php" class="btn btn-secondary">Cancelar</a>
            </div>
        </form>
    </div>
