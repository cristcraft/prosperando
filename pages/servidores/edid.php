        ...
        <form action="../../../components/servidores/edidForm.php" method="POST" id="form_edit_tablets" class="form" >
            <?php while($row = $result -> fetch_assoc()){ ?>
                ...
                <div class="mb-3">
                    ...
                    <input required type="text" name="marca" id="marca" placeholder="marca" class="form-control" value="<?php echo $row['marca'] ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input required type="date" name="fecha" id="fecha" placeholder="fecha" class="form-control" value="<?php echo $row['fecha'] ?>">
                </div>

                <div class="mb-3">
                    <label for="nombre_equipo" class="form-label">Nombre del equipo</label>
                    <input required type="text" name="nombre_equipo" id="nombre_equipo" placeholder="Nombre del equipo" class="form-control" value="<?php echo $row['nombre_equipo'] ?>">
                </div>

                <div class="mb-3">
                    <label for="procesador" class="form-label">Procesador</label>
                    <input required type="text" name="procesador" id="procesador" placeholder="procesador" class="form-control" value="<?php echo $row['procesador'] ?>">
                </div>

                <div class="mb-3">
                    <label for="generacion" class="form-label">Generacion</label>
                    <input required type="number" name="generacion" id="generacion" placeholder="generacion" class="form-control" value="<?php echo $row['generacion'] ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input required type="text" name="velocidad_mz" id="velocidad_mz" placeholder="velocidad_mz" class="form-control" value="<?php echo $row['velocidad_mz'] ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input required type="text" name="tipo_memoria" id="tipo_memoria" placeholder="tipo_memoria" class="form-control" value="<?php echo $row['tipo_memoria'] ?>">
                </div>

                <div class="mb-3">
                    <label for="adaptador_multimedia" class="form-label">Adaptador multimedia</label>
                    <input required type="text" name="adaptador_multimedia" id="adaptador_multimedia" placeholder="adaptador_multimedia" class="form-control" value="<?php echo $row['adaptador_multimedia'] ?>">
                </div>

                <div class="mb-3">
                    <label for="adaptador_video" class="form-label">Adaptador video</label>
                    <input required type="text" name="adaptador_video" id="adaptador_video" placeholder="adaptador_video" class="form-control" value="<?php echo $row['adaptador_video'] ?>">
                </div>

                <div class="mb-3">
                    <label for="red_ethernet" class="form-label">Red ethernet</label>
                    <input required type="text" name="red_ethernet" id="red_ethernet" placeholder="red_ethernet" class="form-control" value="<?php echo $row['red_ethernet'] ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input required type="text" name="ip" id="ip" placeholder="ip" class="form-control" value="<?php echo $row['ip'] ?>">
                </div>

                <div class="mb-3">
                    <label for="red_ethernet1" class="form-label">Red ethernet1</label>
                    <input required type="text" name="red_ethernet1" id="red_ethernet1" placeholder="red_ethernet1" class="form-control" value="<?php echo $row['red_ethernet1'] ?>">
                </div>

                <div class="mb-3">
                    <label for="mac1" class="form-label">mac1</label>
                    <input required type="text" name="mac1" id="mac1" placeholder="mac1" class="form-control" value="<?php echo $row['mac1'] ?>">
                </div>

                <div class="mb-3">
                    <label for="ip1" class="form-label">IP1</label>
                    <input required type="text" name="ip1" id="ip1" placeholder="ip1" class="form-control" value="<?php echo $row['ip1'] ?>">
                </div>

                <div class="mb-3">
                    <label for="so" class="form-label">SO</label>
                    <input required type="text" name="so" id="so" placeholder="so" class="form-control" value="<?php echo $row['so'] ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input required type="text" name="total_discos" id="total_discos" placeholder="total_discos" class="form-control" value="<?php echo $row['total_discos'] ?>">
                </div>
            ...
            <div class="mb-3 d-flex justify-content-around align-items-center">
                ...
                <a href="../../../pages/servidores/servidores.php" class="btn btn-secondary">Cancelar</a>
            </div>
        </form>
    </div>
